export const ENDPOINTS = {
  USER: {
    ...
    SET_ADMIN: (userId: string) => `/users/${userId}/set-admin`,
  ...
  PRODUCT: {
    ...
    GET_PRODUCT_BY_ID: (productId: string) => `/products/${productId}`,
    UPDATE_PRODUCT: (productId: string) => `/products/${productId}/update`,
    ARCHIVE_PRODUCT: (productId: string) => `/products/${productId}/archive`,
    ACTIVATE_PRODUCT: (productId: string) => `/products/${productId}/activate`,
